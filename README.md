...
You place the JavaScript function you want to execute inside the opening tag of the 
...
Now, let's change the GiftHub text to blue by using the click eventListner
...
This is our new HTML:
 ...
 This time around in our script, we need to select the button too (not just the GiftHub text). That’s because there’s nothing JavaScript in the opening tag of our button, which is cool.
